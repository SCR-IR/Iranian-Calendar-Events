...
# مناسبت‌های متغیر
(این مناسبت‌های زیر، در فایل درج نشده‌اند. زیرا برای سال‌های مختلف، روز آن‌ها متفاوت است. پس باید با کدنویسی به‌صورتی اِعمال نمایید که نسبت به سال موردنظر، در روز صحیح خود قرار گیرند.)
___
